...
if __name__ == "__main__":
    ...
    plot_acc(dataset=args.dataset, modelname="rwll", resultsdir=args.resultsdir, savedir=args.savedir, ymin=70, bbox_to_anchor=(bbox_x,-0.16), acq_to_show=args.acq, xmax=100, ncol=3)
